def configuration_list(task):
 ...
 ################ Chase Tasks #################
    ...
    if task == "Chase_Swimmer_Multi333":
        config = {
            # robot setting
            'robot_base': 'xmls/swimmer.xml',  
...
def configuration(task):
    try:
        ...
        #         Type = Constraints[i:]
        #         break
        new_task = Task + "_" + Robot  + "_" + Constraints 
